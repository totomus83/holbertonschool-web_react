  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="w-[400px] ml-auto border-2 border-dashed border-[var(--main-color)] p-2 max-[912px]:w-full max-[912px]:fixed max-[912px]:inset-0 max-[912px]:z-50 max-[912px]:bg-white max-[912px]:p-3">
